  ...
  return (
    <section className="media-section" aria-label="Music video player section">
      ...
      <div className="media-content">
        <h1 className="media-title">New Music Video "Slippin on 7" Out Now!</h1>
        
        <YouTubePlayer videoId="nTTfOvAGMew" playerId="youtube-player-1" />
        <p className="media-subtitle">Watch our other music video "Blue House" below.</p>
        <YouTubePlayer videoId="puzvgHlI0iQ" playerId="youtube-player-2" />
      </div>
    </section>
  );
}
